...
class QuantSettings:
    ...
    sleepTime = 4
    maxDocsToCopy = 3
    maxDocsToWriteBack = 4
    minDocsToWriteBack = 2
    quantDocsLimit = 4
    useFtp = True
...
class GridSettings:
    ...
    qualNodes = ['192.168.1.238'] #
    quantNodes = ['192.168.1.238']#,'192.168.1.180','192.168.1.250']
    sleepTime = 1
    ip = '192.168.1.203'
    name = 'GridManager:QL'
    ...
    quantDocsQuery = 'select documentid from cap2.tableparsingqueue_ap where status = "PENDING" \
                    and tableextractionpoller = "None"  order by timestamp limit %l'
